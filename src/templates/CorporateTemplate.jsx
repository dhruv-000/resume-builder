...
function CorporateTemplate({ resume }) {
  const accent = resume.themeColor || '#1d4ed8'
    ...
    <div className={`${fontClass} ${density.pagePadding} text-stone-900`}>
      ...
      <main className={`mt-4 ${density.sectionSpacing}`}>
        ...
        {content.experience.length > 0 && (
          <section>
            <SectionTitle accent={accent} text="WORK EXPERIENCE" />
            <div className="mt-2 space-y-2.5">
        ...
        {content.internships.length > 0 && (
          <section>
            <SectionTitle accent={accent} text="INTERNSHIPS" />
            <div className="mt-2 space-y-2.5">
        ...
        {(content.skillGroups.length > 0 || content.skills.length > 0) && (
          <section>
            <SectionTitle accent={accent} text="SKILLS" />
        ...
        {content.extracurricular.length > 0 && (
          <section>
            <SectionTitle accent={accent} text="EXTRACURRICULAR / LEADERSHIP" />
            <ul className="mt-2 space-y-1.5">
